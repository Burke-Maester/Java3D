public class Calculator {
	...
	static double[] GetProj(double[] ViewFrom, double[] ViewTo, double x, double y, double z, Plane P) {
        ...
        t =
            (P.NV.x * P.P[0]        + P.NV.y * P.P[1]        + P.NV.z * P.P[2] - (P.NV.x * ViewFrom[0] + P.NV.y * ViewFrom[1] + P.NV.z * ViewFrom[2])) /
	...
	static void SetPrederterminedInfo() {
		...
		PlaneVector1    = ViewVector.CrossWith(DirectionVector);
		PlaneVector2    = ViewVector.CrossWith(PlaneVector1);
		...
		W1             = ViewVector.CrossWith(RotationVector);
		W2             = ViewVector.CrossWith(W1);
